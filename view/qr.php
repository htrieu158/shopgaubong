                        ...
                        <div class="info-box">
                            ...
                            <div class="entry">
                                <p><i class="fa fa-credit-card" aria-hidden="true"></i>
                                    ...
                                    <br>
                                    <b id="copyStk" style="padding-left: 25px;word-break: keep-all;color:greenyellow;">128001005200</b>
                            ...
                            <div class="entry">
                                <p><i class="fa fa-user" aria-hidden="true"></i>
                                    ...
                                    <br>
                                    <span style="padding-left: 25px;word-break: keep-all;">LA VAN HUNG</span>
                                </p>
                            </div>
                            <div class="entry">
